...
/*
 * // JavaRush
 * Задача: Подготовка рюкзака искателя приключений 🎒
 * Ссылка: https://javarush.com/tasks/ru.javarush.java.core.level07.task01
 */

/*
 * // CodeGym
 * Task: Preparing the Adventurer's Backpack 🎒
 * Link: https://codegym.cc/tasks/en.codegym.java.core.level07.task01
 */
