...
/*
 * // JavaRush
 * Задача: Сверхсекретный банковский счет клиента 🔒
 * Ссылка: https://javarush.com/tasks/ru.javarush.java.core.level08.task18
 */

/*
 * // CodeGym
 * Task: Top-Secret Customer Bank Account 🔒
 * Link: https://codegym.cc/tasks/en.codegym.java.core.level08.task18
 */
 ...
 *
 *         // Попытка прямого доступа к приватному полю извне класса:
 *         myPrivateAccount.accountBalance = 2000; // Error: accountBalance has private access in CustomerBankAccount
 *     }
 * }
 *
 * // Класс секретного банковского счета клиента
